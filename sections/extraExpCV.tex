...
%---------------------------------------------------------
  ...
  \cventry
    ...
    {
	\begin{cvitems} % Description(s) of tasks/responsibilities
      	\item Provide gate-keeping support, verify event tickets and vendor information, respond to inquiries about space location, and assist in the flea market operation.
	\end{cvitems}
    }
